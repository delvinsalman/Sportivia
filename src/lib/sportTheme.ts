...
/** Red stitching — baseball secondary accent only */
...
export const SPORTS: Sport[] = ['soccer', 'basketball', 'baseball'];

export type ComingSoonSport = 'football' | 'hockey';

export const COMING_SOON_SPORTS: ComingSoonSport[] = ['football', 'hockey'];
