...
const GUIDE: Array<{
  ...
  },
  {
    ...
    demo: '/demos/five-sports.m4v',
  },
  {
    eyebrow: 'Modes',
    title: 'Play how you want',
    body: 'Training is practice with no rewards. Quick Play is Kahoot-style trivia with light coins. Guess the Player is typed trivia: identify one hidden athlete from progressive clues for strong coin payouts. Daily is a shared board with a first-finish payday. Ranked is timed and competitive. Vs AI races a bot. 1v1 Duel is a live lobby with a code. Campaign is the long climb.',
    Icon: Gamepad2,
