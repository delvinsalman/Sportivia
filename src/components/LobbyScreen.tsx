        ...
        <div className="flex min-h-0 flex-1 flex-col px-3 pb-[max(0.75rem,env(safe-area-inset-bottom))] sm:px-5">
          {!inLobby ? (
            ...
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              className={`mx-auto flex w-full min-h-0 flex-col overflow-hidden rounded-[24px] border-[3px] border-[#ed4245]/70 bg-[#121316]/95 shadow-[0_7px_0_#8f1e22] backdrop-blur-md ${
                bothHere
                  ? 'max-h-full max-w-4xl'
                  : 'my-auto max-w-xl'
              }`}
            >
              {/* Top bar: sport + code */}
              ...
              {/* Wide body: players | stake */}
              <div
                className={`min-h-0 flex-1 px-4 py-3 sm:px-5 ${
                  bothHere
                    ? 'grid grid-cols-1 gap-3 sm:grid-cols-[minmax(200px,0.85fr)_1.35fr] sm:gap-4'
                    : ''
                }`}
              >
                {/* Players column */}
                <div className="flex min-h-0 flex-col gap-2">
                  ...
                  <div className={`grid gap-2 ${bothHere ? 'grid-cols-1' : 'grid-cols-2'}`}>
                    {[0, 1].map(slot => {
                  ...
                  {!bothHere && (
                    <div className="mt-2 rounded-xl border border-white/10 bg-[#151619]/80 px-3 py-4 text-center">
                  ...
                  {nothingToStake && (
                    <div className="mt-1 flex flex-1 flex-col items-center justify-center rounded-xl border-[2.5px] border-[#f0b232]/40 bg-[#f0b232]/10 px-3 py-4 text-center">
                ...
                {/* Stake column — only when both here + have cards */}
                {bothHere && !nothingToStake && (
                  <div className="flex min-h-0 flex-col gap-2 border-t border-white/10 pt-3 sm:border-l sm:border-t-0 sm:pl-4 sm:pt-0">
                    ...
                    <div className="flex shrink-0 flex-col gap-1.5 sm:flex-row sm:items-center">
                      <label className="flex min-h-9 min-w-0 flex-1 items-center gap-2 rounded-xl border-[2.5px] border-[#2b2d31] bg-[#1a1b1f] px-2.5">
                    ...
                    <div className="min-h-0 max-h-[min(38svh,280px)] flex-1 overflow-y-auto overscroll-contain sm:max-h-[min(42svh,320px)]">
                      {filtered.length ? (
                    ...
                    <button
                      ...
                      className={`shrink-0 w-full rounded-xl border-[2.5px] py-2 text-xs font-black ${
              ...
              <div className="flex shrink-0 items-center gap-2 border-t border-white/10 px-4 py-2.5 sm:px-5">
                ...
                <button
                  type="button"
                  onClick={handleBack}
                  className="shrink-0 px-2 py-2 text-xs font-black text-[#6d6f78] transition-colors hover:text-[#f2f3f5]"
                >
                  Leave
                </button>
              </div>
