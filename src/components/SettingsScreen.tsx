      ...
      <div className="relative z-10 h-svh flex flex-col overflow-hidden">
        <header className="shrink-0 flex items-center px-3 sm:px-6 pt-3 pb-1">
          <button
            type="button"
            onClick={back}
            className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-full text-xs font-black text-[#b5bac1] hover:text-[#f2f3f5] bg-[#1e1f22] border-[2.5px] border-[#3f4147] hover:border-[#5c5e66] shadow-[0_3px_0_#1a1b1f] hover:translate-y-[1px] hover:shadow-[0_2px_0_#1a1b1f] transition-all"
          >
        ...
        <div className="flex-1 min-h-0 overflow-y-auto overscroll-contain px-3 sm:px-6 pb-[max(1.5rem,env(safe-area-inset-bottom))]">
          <div className="w-full max-w-lg mx-auto space-y-4 py-3">
