          ...
          {cells.map((cell, i) => {
            ...
            return (
              <motion.button
                ...
                className={`
                  relative aspect-square rounded-xl sm:rounded-2xl flex flex-col items-center justify-center gap-1 sm:gap-1 p-1.5 sm:p-2
              ...
              >
                {isFilled ? (
                  ...
                  <>
                    <div className="mb-0.5 flex h-[30px] shrink-0 items-center justify-center leading-none">
